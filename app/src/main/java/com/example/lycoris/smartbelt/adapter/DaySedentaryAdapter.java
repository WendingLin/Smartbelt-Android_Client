...
/**
 * Created by Eclair D'Amour on 2016/9/20.
 */
public class DaySedentaryAdapter  extends BaseAdapter{
    ...
    public DaySedentaryAdapter(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.tvDuration = (TextView) convertView.findViewById(R.id.tv_daypace_pace);
        ...
        listItemView.tvDuration.setText((String) listItems.get(position).get("duration"));
