 ...
 */
public abstract class BaseChartUtils {
    private static final String TAG = BaseChartUtils.class.getSimpleName();
    protected Context mContext;
    protected XYMultipleSeriesRenderer mXYRenderer;
    protected XYMultipleSeriesDataset mXYMultipleSeriesDataSet;

    protected BaseChartUtils(Context context) {
    ...
    private void initRender() {
        BaseChartLogUtils.LOGE(TAG,"initRender");
        // 1, 构造显示用渲染图
        float textSize = 20f;
